...
function renderIndex(){
  const footer = el('footer',[],el('div',['class="footer"'],'Powered by' + el('a',['class="ui label"','href="https://github.com/y567800y/cf-worker-dir"','target="_blank"'],el('i',['class="github icon"'],"") + 'Cf-Worker-Dir') + ' &copy; Base on ' + el('a',['class="ui label"'],el('i',['class="balance scale icon"'],"") + 'MIT License')));
...
function renderHTML(index,seller) {
  ...
  <head>
      ...
      <link href="https://cdn.jsdelivr.net/gh/y567800y/cf-worker-dir@0.1.1/style.css" rel="stylesheet">
